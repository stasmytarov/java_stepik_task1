...
Предполагается, что реализуется алгоритм слияния, имеющий линейную сложность. 
Он будет идти по двум исходным массивам и сразу формировать отсортированный результирующий массив. 
Задача должна быть решена так, чтобы сортировка полученного массива при помощи Arrays.sort() уже не требовалась. 
Пример:
